...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Handle ref={ref} className={className} {...props} />
));
...
const drawerContentVariants = cva(
  "fixed z-50 flex h-auto flex-col border bg-background scrollbar-width-none -ms-overflow-style-none",
  {
    variants: {
      direction: {

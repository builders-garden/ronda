...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-3 pr-2 text-sm outline-none data-[highlighted]:bg-zinc-100 data-[state=checked]:bg-zinc-100 data-[state=checked]:text-zinc-950 data-[state=unchecked]:text-zinc-600 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >

      ...
      <Drawer onOpenChange={setIsDrawerOpen} open={isDrawerOpen}>
        ...
        <DrawerContent className="w-full rounded-none border-none focus:outline-none">
          ...
          <div className="flex h-[69px] w-full items-center justify-between border-border border-b bg-white px-4">
            <motion.button
              className="flex size-11 shrink-0 cursor-pointer items-center justify-center rounded-2xl bg-muted/5"
              onClick={() => setIsDrawerOpen(false)}
              type="button"
              whileTap={{ scale: 0.98 }}
            >
              <ArrowLeft className="size-6 text-muted" strokeWidth={2} />
            </motion.button>
            ...
            <div className="flex w-full flex-col gap-6 px-4 py-6">
              <Card className="flex w-full flex-col gap-6 rounded-[24px] border border-border bg-white p-6 shadow-none">
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    className="h-[29px] rounded-full border-none bg-warning/5 px-3 py-1.5 font-semibold text-[11px] text-warning uppercase tracking-[0.275px]"
                    variant="outline"
                  >
                    Pending Invitation
                  </Badge>
              ...
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-[16px] text-muted tracking-[-0.4px]">
                  Members
                </h2>
                <motion.button
                  className="cursor-pointer font-semibold text-[12px] text-muted tracking-[-0.3px] hover:underline"
                  whileTap={{ scale: 0.98 }}
                >
          ...
          <div className="flex w-full flex-col gap-2 border-border border-t bg-white p-4">
            <Button
              className="h-16 w-full cursor-pointer rounded-[24px] bg-primary font-semibold text-[16px] text-white tracking-[-0.4px] hover:bg-primary/90"
              onClick={handleAccept}
            >
              Accept Invitation
            </Button>
            <Button
              className="h-[58px] w-full cursor-pointer rounded-[24px] border border-none bg-white font-semibold text-[16px] text-zinc-950 tracking-[-0.4px] hover:bg-zinc-50"
